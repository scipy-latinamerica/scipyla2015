...
bem como sobre o transporte urbano para chegar à conferência.

**AVISO: Todo o conteúdo a seguir são sugestões para guiar os participantes até a sede.
...
e tomar um ônibus partindo de Puerto Iguazú até Posadas.

Para os custos aéreos verificar
...
Argentina. **O ônibus internacional não entra nas instalações do
...
em Puerto Iguazú, Misiones, Argentina. No local você pode tomar um ônibus
para a cidade de Posadas, a capital provincial, a um custo aproximado de US$18.
Dependendo da empresa, a viagem leva cerca de 5 horas.
...
Ezeiza. Já no país, se você quiser ir para Posadas de ônibus terá
que ir para o **terminal de ônibus de Retiro**; se de avião terá que ir ao
**Aeroporto Jorge Newbery (Aeroparque)**. Em ambos os casos, é recomendado pegar
...
<div style="text-align:center">
    ...
    <br/>Aeroporto Jorge Newbery (Aeroparque)
</div>
...
-   Dirigir pela Estrada 14 até chegar em Misiones pela Estrada 105.

**O trajeto possui pedágio.**

Como ir de Córdoba à Posadas
================================

Voos
------

Os voos que vão de Córdoba à Posadas tem uma conexão no
Aeroporto Jorge Newbery da cidade de Buenos Aires (Aeroparque). O trecho
que liga o Aeroparque com o Aeroporto de Posadas tem poucos
passageiros, o que deixa o custo bastante elevado.
(Aproximadamente **U$S 250**)

Para mais informações consultar: <http://www.despegar.com.ar> ou
<http://www.decolar.com/>

##Ônibus

As empresas mais importantes que fazem rota entre essas cidades são a Crucero del Norte
(<http://crucerodelnorte.com.ar>) e Zinger (<http://expresosinger.com.ar/>).
Ambas contam com diferentes serviços de comida a bordo em um
trajeto que dura por volta de **16 hs** por um custo de **U$S 115.**

Para mais informações consultar: <http://www.plataforma10.com>

##Carro Particular

Recomenda-se seguir a seguinte rota (há pedágios):

-   Pegar a rota nacional 19 que une a cidade de Córdoba com Santa Fé Capital
-   Cruzar a cidade de Paraná (Entre Rios) pelo túnel subfluvial.
-   Dirigir-se pela rota nacional 12 até emendar com a rota provincial 127.
-   Continuar na rota provincial 127 até emendar com a rota nacional 14.
-   Continuar pela rota nacional 14 até chegar a Provincia de
    Misiones a emendar com a rota provincial 105.
-   Continuar pela rota provincial 105 até a cidade de Posadas

##Como chegar de Rosario a Posadas

###Voos

Por conta da distância é conveniente tomar voos diretamente do  Aeroporto
Jorge Newbery de Buenos Aires. Para outras alternativas consultar:
<http://www.despegar.com.ar> ou <http://www.decolar.com/>

###Ônibus

**U$S 92** semi-leito e **U$S 105** leito na Río Uruguay.
...
-   Pegar a estrada Rosario-Santa Fe.
-   Cruzar a ciudad de Paraná (Entre Rios) pelo túnel subfluvial.
-   Dirigir-se pela rota nacional 12 até emendar com a rota provincial 127.
-   Continuar pela rota provincial 127 até emendar com a rota nacional 14.
-   Continuar pela rota nacional 14 até chegar a Provincia de Misiones 
    a emendar com a rota provincial 105.
-   Continuar pela rota provincial 105 até a cidade de Posadas


##Sistema de Transporte Urbano de Posadas

###Terminal de ônibus de longa distância -\> Universidad Gastón Dachary

<div style="text-align:center">
    <img src ="https://github.com/scipy-latinamerica/scipyla2015/raw/master/travel_guide/imgs/posadas_terminal.jpg" />
    <br/>Terminal de Ônibus de Posadas
</div>

-   **Táxi**

    Pode-se pegar um táxi direto do terminal de ônibus para
    chegar na universidade por um custo aproximado de **U$S 7**.
...
-   **Ônibus Urbano - Linha 14B**

    Frequência: a cada X minutos

    Custo: **U$S 1**

    Percurso: Avda. Sta. Catalina, Avda. Cte. Andresito, Avda. Lavalle, Avda.
    Chacabuco, Avda. F. de Haro, Avda. Mitre, Buenos Aires. Descer em calle
    Tucumán

-   **Ônibus Urbano - Linha 15A**

    Frequência: cada X minutos

    Custo: **U$S 1**

    Percurso: Avda. Sta. Catalina, Av Sta. Cruz, Avenida Lavalle, Avenida L. y
    Planes, Avenida Mitre, Ayacucho. Descer em calle Tucumán

Mais informações sobre os percursos em:
<http://www.argentino.com.ar/posadas/recorridos+de+colectivos>

###Aeroporto -\> Universidad Gastón Dachary


<div style="text-align:center">
    <img src ="https://github.com/scipy-latinamerica/scipyla2015/raw/master/travel_guide/imgs/posadas_airport.jpg" />
    <br/>Aeroporto de Posadas
</div>


-  **Táxi**

    Pode-se tomar um táxi diretamente no aeroporto  para chegar a
    universidade por um custo aproximado de  **U$S 10**

-   **Ônibus Urbano - Linha 28**

    Frequência: cada 30 minutos
    Tarifa: **U$S 1**

    Percurso: Acceso oeste hasta RN 12, Avda. San Martín hasta Avda. Lopez y
    Planes, Avda. Corrientes hasta Santa Fe. Descer em calle San Lorenzo o
    Buenos Aires
